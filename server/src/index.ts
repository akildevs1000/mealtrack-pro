...
import foodEstimationsRouter from "./routes/food-estimations.js";
import employeesRouter from "./routes/employees.js";
import devicesRouter from "./routes/devices.js";
import managersRouter from "./routes/managers.js";
import cateringCompaniesRouter from "./routes/catering-companies.js";
import distributorEmployeesRouter from "./routes/distributor-employees.js";
...
app.use("/api/food-estimations", foodEstimationsRouter);
app.use("/api/employees", employeesRouter);
app.use("/api/devices", devicesRouter);
app.use("/api/managers", managersRouter);
app.use("/api/catering-companies", cateringCompaniesRouter);
app.use("/api/distributor-employees", distributorEmployeesRouter);
